...
public class CreateNewsTest {
    ...
    public void createNewsTest() {
        ...
        ViewInteraction textInputEditText4 = onView(
                allOf(withId(R.id.news_item_description_text_input_edit_text),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText4.perform(replaceText("Happy New Year"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.news_item_description_text_view), withText("Happy New Year"),
                        withParent(withParent(withId(R.id.news_item_material_card_view))),
                        isDisplayed()));
        textView.check(matches(withText("Happy New Year")));
    }
