...
public class ChangeNewsTest {
    ...
    public void changeNewsTest() {
        ...
        ViewInteraction textInputEditText = onView(
                allOf(withId(R.id.news_item_title_text_input_edit_text), withText("testTit-5ad"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText.perform(replaceText("Change News"));

        ViewInteraction textInputEditText2 = onView(
                allOf(withId(R.id.news_item_title_text_input_edit_text), withText("Change News"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.news_item_title_text_input_layout),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.news_item_title_text_view), withText("Change News"),
                        withParent(withParent(withId(R.id.news_item_material_card_view))),
                        isDisplayed()));
        textView.check(matches(withText("Change News")));
    }
